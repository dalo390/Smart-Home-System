  ...
  return(
    <>
      <LineChart className="graph" width={500} height={300} data={dateData}>
        ...
        <Line type="monotone" dataKey="gallons" strokeDasharray="5 5" stroke="8884d8" dot={false} />
        <Line type="monotone" dataKey="cost" strokeDasharray="5 5" stroke="82ca9d" dot={false} />
        <Line type="monotone" dataKey="kwh" strokeDasharray="5 5" stroke="FF5733" dot={false} />
        <Legend />
      </LineChart>
